  ...
  >
    ...
    <div class="app-bar">
      <a class="app-title-container" style="display: flex; align-items: center;" href="/">
        ...
        <h1 class="app-title" style="font-size: 20px;margin: 0 25px 0 8px; user-select: none;">Moealkyne</h1>
      </a>
...
export default {
  data: () => ({
    ...
    uploadProgress: null,
    uploadQueue: [],
    backgroundImageUrl: "/assets/bg-light1.webp",
    needLogin: false,
    ...
    cwd: {
      handler() {
        ...
        document.title = this.cwd.replace(/.*\/(?!$)|\//g, "") === "/"
            ? "FlareDrive-R2 - 鸣潮攻略项目网盘"
            :`${this.cwd.replace(/.*\/(?!$)|\//g, "") || "/" } - 鸣潮攻略项目网盘`;
      },
      immediate: true,
    },
